...
def test_task_source_ros(patched_run):
    """check ros env"""
...
def test_task_pkg_create_cmd(patched_run):
...
def test_task_colcon_build_cmd(patched_run):
...
def test_task_xhost_cmd(patched_run):
    """check xhost"""
